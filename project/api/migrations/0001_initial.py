# Generated by Django 5.1.1 on 2025-06-17 15:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('case', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='api.case')),
                ('cooler', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='api.cooler')),
                ('disc', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='api.disc')),
                ('fan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.fan')),
                ('graphic_card', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='api.graphiccard')),
                ('motherboard', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='api.motherboard')),
                ('power_unit', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='api.powerunit')),
                ('processor', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='api.processor')),
            ],
        ),
    ]
